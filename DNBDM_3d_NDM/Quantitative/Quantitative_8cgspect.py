...
def data_show(full_dose_folder, gen_dose_folder, QA_save_path):
    ...
    for patient_id in patient_ids:
        ...
        gen_dose_filename = f'150000_0_test_8cg_ddim_P{patient_id}.tif'
...
if __name__ == '__main__':
    # Define paths
    full_dose_folder = '/hy-tmp/8cgspect_ground3d'  # 全剂量图像文件夹
    gen_dose_folder = '../output/corediff_8cgspect_10t/save_tif'   # 降噪图像文件夹
    QA_save_path = '../output/corediff_8cgspect_100t_duibi'        # 结果保存路径
